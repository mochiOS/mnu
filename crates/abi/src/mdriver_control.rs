...
pub const MDRIVER_CONTROL_OPEN_BLOCK_QUEUE: u16 = 11;
...
pub const MDRIVER_CONTROL_CREATE_PARTITION: u16 = 16;
pub const MDRIVER_CONTROL_DELETE_PARTITION: u16 = 17;
pub const MDRIVER_CONTROL_OPEN_DISPLAY: u16 = 18;
pub const MDRIVER_CONTROL_DISPLAY_INFO: u16 = 19;
pub const MDRIVER_CONTROL_PRESENT_DISPLAY: u16 = 20;
...
pub const MDRIVER_CONTROL_CAP_STORAGE_MUTATION: u64 = 1 << 6;
pub const MDRIVER_CONTROL_CAP_DISPLAY: u64 = 1 << 7;
pub const MDRIVER_CONTROL_CAPABILITIES: u64 = MDRIVER_CONTROL_CAP_INVENTORY
    ...
    | MDRIVER_CONTROL_CAP_STORAGE_MUTATION
    | MDRIVER_CONTROL_CAP_DISPLAY;
...
pub const MDRIVER_DEVICE_FEATURE_READ_ONLY: u64 = 1 << 4;
pub const MDRIVER_DEVICE_FEATURE_PARTITIONED: u64 = 1 << 5;
...
pub const MDRIVER_BLOCK_QUEUE_DEPTH: u64 = 4;
