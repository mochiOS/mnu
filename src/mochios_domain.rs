...
use mnu_abi::mdriver_control::{
    MdriverControlRequest, MdriverControlResponse, MDRIVER_CONTROL_CAPABILITIES,
    ...
    MDRIVER_CONTROL_STATUS_OK, MDRIVER_CONTROL_STATUS_UNSUPPORTED_OPERATION,
    MDRIVER_CONTROL_VERSION, MDRIVER_DEVICE_FEATURE_DMA_ISOLATED,
