...
pub fn dispatch(num: u64, arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) -> u64 {
    match num {
        ...
        x if x == SyscallNumber::FileOpen as u64 => fs::open(arg0, arg1),
        x if x == SyscallNumber::FileClose as u64 => fs::close(arg0),
        x if x == SyscallNumber::FileRead as u64 => fs::read(arg0, arg1, arg2),
        x if x == SyscallNumber::FileSeek as u64 => fs::seek(arg0, arg1 as i64, arg2),
        x if x == SyscallNumber::FileStat as u64 => fs::stat(arg0, arg1),
        x if x == SyscallNumber::FileTruncate as u64 => fs::truncate(arg0, arg1),
        _ => ENOSYS,
    }
}
